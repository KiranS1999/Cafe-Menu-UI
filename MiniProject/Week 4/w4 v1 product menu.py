    ...
    while True:
        ...
        if user_input == 0:
            ...
            #overwrite file with new list
                ...
                w = csv.DictWriter(file, products.keys())
                w.writerwos(products)
                file.close
